const Footer = () => {
  return <footer className="w-full bg-zinc-950">
    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 mt-10">
      <div
        className="flex flex-col items-center gap-4 rounded-lg bg-indigo-900 p-6 shadow-lg sm:flex-row sm:justify-between"
      >
        <strong className="text-xl text-white sm:text-xl"> Make Your Next Career Move! </strong>
  
        <p
          className="cursor-pointer inline-flex items-center gap-2 rounded-md border border-white bg-white px-8 py-3 text-indigo-600 hover:bg-transparent hover:text-white focus:outline-none focus:ring active:bg-white/90"
        >
